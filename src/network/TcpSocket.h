...
public:
    ...
    /**
     * used to detect slow read.
     * @param switch_read_strategy from InputStreamImpl.
     */
    void setSwitchReadStrategy( std::shared_ptr<FastSwitchReadStrategy> switch_read_strategy);
    ...
    /**
     * getter of remoteAddr
     */
    std::string getRemoteAddr() const {return remoteAddr;}
