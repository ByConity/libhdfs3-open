...
class HdfsSlowReadException: public HdfsIOException {
public:
    HdfsSlowReadException(const std::string & arg, const char * file, int line,
                    const char * stack) :
        HdfsIOException(arg, file, line, stack) {
    }

    ~HdfsSlowReadException() throw () {
    }
...
public:
    HdfsNetworkException(const std::string & arg, const char * file, int line,
                         const char * stack) :
        HdfsIOException(arg, file, line, stack) {
            detail = std::string("<HdfsNetworkException> ") + detail;
    }
...
public:
    FileNotFoundException(const std::string & arg, const char * file, int line,
                          const char * stack) :
        HdfsException(arg, file, line, stack) {
            detail = std::string("<FileNotFoundException> ") + detail;
    }
...
public:
    HdfsCanceled(const std::string & arg, const char * file, int line,
                 const char * stack) :
        HdfsException(arg, file, line, stack) {
            detail = std::string("<HdfsCanceled> ") + detail;
    }
...
public:
    HdfsFileSystemClosed(const std::string & arg, const char * file, int line,
                         const char * stack) :
        HdfsException(arg, file, line, stack) {
            detail = std::string("<HdfsFileSystemClosed> ") + detail;
    }
...
public:
    HdfsInvalidBlockToken(const std::string & arg, const char * file, int line,
                          const char * stack) :
        HdfsException(arg, file, line, stack) {
            detail = std::string("<HdfsInvalidBlockToken> ") + detail;
    }
