...
#ifndef HDFS_EINTERNAL
#define HDFS_EINTERNAL 254
#endif

#else

#ifndef O_RDONLY
constexpr auto O_RDONLY = 1;
#endif
#ifndef O_WRONLY
constexpr auto O_WRONLY = 2;
#endif
#ifndef HDFS_EINTERNAL
constexpr auto HDFS_EINTERNAL = 255;
#endif
#ifndef HDFS_EFAILED
constexpr auto HDFS_EFAILED = 254;
#endif
 ...
 * @return       Returns a handle to the filesystem, or NULL on error.
 */
hdfsFS hdfsBuilderConnect(struct hdfsBuilder * bld, const char * effective_user=nullptr);
...
hdfsFile hdfsOpenFile(hdfsFS fs, const char * path, int flags, int bufferSize,
                      short replication, tOffset blocksize, hdfsEventCallBack cb = nullptr);
...
/**
 * hdfsPRead - Read data from an open file.
 * @param fs The configured filesystem handle.
 * @param file The file handle.
 * @param buffer The buffer to copy read bytes into.
 * @param length The length of the buffer.
