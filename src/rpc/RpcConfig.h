...
public:
    ...
    RpcConfig(const SessionConfig & conf) {
        ...
        useInternalCredentialFormat = conf.getUseInternalCredentialFormat();
    }
    ...
    void setUseInternalCredentialFormat(bool use_internal) {
        useInternalCredentialFormat = use_internal;
    }
    ...
    bool operator ==(const RpcConfig & other) const {
        return this->maxIdleTime == other.maxIdleTime
               ...
               && this->useInternalCredentialFormat == other.useInternalCredentialFormat;
    }
